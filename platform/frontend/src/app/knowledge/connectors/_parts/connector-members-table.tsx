...
/**
 * Group memberships rendered like the documents table's Access column: the
 * first two as outline badges, the rest collapsed behind a "+N more" badge
 * whose tooltip lists all of them (scrollable).
 */
